  ...
  return (
    <>
      ...
      <div className="absolute top-14 left-0 right-0 bg-main">
        <div className="max-w-[1280px] m-auto p-4 grid grid-cols-1 md:grid-cols-detail-2 lg:grid-cols-detail-3 gap-x-0 md:gap-x-4">
          <div>
            <div className="fixed left-0 right-0 bottom-0 md:sticky md:top-emoticon md:left-0 md:right-0 z-10 bg-white md:bg-transparent rounded-md md:rounded-none shadow-mobile-menu md:shadow-none p-2 md:p-0">
              <div className="flex justify-around items-center md:grid md:gap-y-4">
                ...
                <div className="relative group">
                  <button
                    type="button"
                    className="rounded-full hover:bg-post-name"
                  >
              ...
              <div className="py-4">
                <div>
                  <p className="text-body text-[1.1rem] font-normal mb-5 leading-normal md:leading-relaxed">
                    ...
                    resistance against the *TypeScript * tide? Or are there
                    others who share this sentiment 😍? Or better yet, are there
                    knights in shining armor ready to defend TypeScript's honor
                    and educate the peasants like me on the path of righteous
                    coding 🤣🤣?
                  </p>
                  <p className="text-body text-[1.1rem] font-normal mb-5 leading-normal md:leading-relaxed">
                  ...
                  <ul className="pl-5 list-disc text-body text-[1.1rem] font-normal">
                    <li>
                      Why is TypeScript hailed as the savior of big projects? Is
                      it really the unsung hero in the sprawling chaos of
                      JavaScript?
                    </li>
                    <li>
                    ...
                    <li>
                      And for my fellow “TypeScript skeptics”, why do you really
                      hate it?
                    </li>
                  </ul>
                </div>
                    ...
                    <div className="rounded-auto p-1 border border-[rgba(23, 23, 23, 0.05)]">
                      <div className="flex justify-between items-center pt-2 px-3">
                        <div className="flex items-center">
                                ...
                                <div className="grid gap-y-4 p-4">
                                  ...
                                  <div>
                                    ...
                                    <div className="mt-3">
                                      ...
                                      <p className="text-left">
                                        <span className="text-base-70 text-2sm font-normal">
                                          B.A. in English from The College of
                                          New Jersey
                                        </span>
                                      </p>
                                    </div>
                          ...
                          <span className="inline-block text-[#BDBDBD] pr-2">
                            •
                          </span>
                      ...
                      <div className="px-4 mt-2">
                        <p className="text-body text-5sm font-normal mb-5 leading-normal">
                          No, you're not the only that hates it. Many also do.
                          It's been the "trendy" thing for a long while and
                          people prefer it because "it has better tooling".
                        </p>
                        <p className="text-body text-5sm font-normal mb-5 leading-normal">
                          But wait and see, the TS era is coming to an end. When
                          some proposals for JS make it to the official spec, TS
                          will be just a memory.
                        </p>
                        <p className="text-body text-5sm font-normal leading-normal">
                          And we will be able to go back to develop for the web
                          using the original holy trio of web dev.
                        </p>
                      </div>
                    </div>
            ...
            <div className="grid gap-y-4">
              <div className="bg-white rounded-auto overflow-hidden shadow-[0_0_0_1px_rgba(23, 23, 23, 0.05)]">
                ...
                <div className="grid gap-y-4 p-4">
                  ...
                  <div>
                    <p className="text-left text-base-70 text-3sm font-normal">
                      I am a Passionate Frontend Web Developer, I design
                      webpages and graphics uniquely and creatively. I also
                      design the webpage layout in a way that is pleasing to the
                      eye and easy on the eyes.
                    </p>
                  </div>
                  <div>
                    <div className="mt-3">
