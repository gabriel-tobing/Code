...
import { closeSidebarMenu } from "../../features/SidebarMenu/sidebarMenuSlice";
...
const SidebarLeftContent = () => {
  ...
  return (
    <div
      className={`absolute top-0 z-10 h-screen overflow-y-scroll md:overflow-y-visible md:h-max md:static bg-base-100 md:bg-transparent bg-opacity-50 transition-all duration-300 ${
        isSidebarOpen ? "left-0" : "-left-[250%]"
      }`}
    >
      <div
        className="w-[80%] md:w-full bg-white md:bg-transparent p-3 md:p-0"
        ref={modalContentRef}
      >
        <div className="min-h-[56px] flex justify-between items-center mb-3 md:hidden">
          <Link>
            <h2 className="flex-1 leading-tight font-semibold text-lg">
              CODE Community
            </h2>
          </Link>
          <button
            type="button"
            className="group shrink-0 p-2 hover:bg-bg-hover rounded-md"
            onClick={handleCloseSidebarMenu}
          >
            <AiOutlineClose className="text-button group-hover:text-branded text-xl" />
          </button>
        </div>
        <div className="bg-white md:p-4 shadow-card rounded-auto">
        ...
        <div className="my-4">
          <div className="flex flex-col">
            ...
            <Link to="/code-advertising-options">
              <button
                type="button"
                className="group flex items-center w-full py-2 px-4 hover:bg-bg-hover rounded-md"
              >
